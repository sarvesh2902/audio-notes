  ...
  return (
    <Layout title="Privacy Policy / AudioNotes">
      <div className="mx-20 mb-10">
        ...
        <p className="text-end">Effective date: 2023-01-07</p>
        <p>
          1. <b>Introduction</b>
        </p>
        <p>
          Welcome to <b> Audio Notes</b>.
        </p>
        <p>
          <b>Audio Notes</b> (“us”, “we”, or “our”) operates{" "}
          <b>https://github.com/sarvesh2902/audio-notes</b> (hereinafter
          referred to as <b>“Service”</b>).
        </p>
        <p>
          Our Privacy Policy governs your visit to{" "}
          <b>https://github.com/sarvesh2902/audio-notes</b>, and explains how we
        ...
        <p>
          <b>SERVICE</b> means the https://github.com/sarvesh2902/audio-notes
          website operated by Audio Notes.
        </p>
        <p>
        ...
        <p>Audio Notes uses the collected data for various purposes:</p>
        ...
        <p>
          Audio Notes will take all the steps reasonably necessary to ensure
        ...
        <p>
          ...
          us at <b>sarvesh2902@gmail.com</b>.
        </p>
        ...
        <p>
          ...
          please send your request(s) by email: <b>sarvesh2902@gmail.com</b>.
        </p>
        <p>
        ...
        <p>
          ...
          by email: <b>sarvesh2902@gmail.com</b>.
        </p>
      </div>
    </Layout>
  );
