            ...
            <div class="text-gray-700 bg-white">
                <div class="py-20 bg-white">
                    <div class="container mx-auto px-6">
                        ...
                        <div class="text-2xl mb-8 text-gray-800">
                            A software that lets you convert video to audio and
                            create notes on specific timestamps
                        </div>
                        <button
                            onClick={() => {
                                router.push("/login");
                            }}
                            class="transform hover:scale-110 transition duration-300 ease-in-out bg-primary-200 font-bold rounded-full py-6 px-8 shadow-lg uppercase tracking-wider text-white"
                        >
                            Get Started
                        </button>
                    </div>
                ...
                <section class="container mx-auto px-6 py-10">
                    ...
                    <div class="flex items-center flex-wrap mb-10">
                        <div class="w-full md:w-1/2 px-4">
                            ...
                            <p class="text-gray-600 text-xl">
                                Upload a video and convert it into audio. You
                                can Play, Pause and Rewind audio.
                            </p>
                        </div>
                        <div class="w-full md:w-1/2 px-4">
                            <img
                    ...
                    <div class="flex items-center flex-wrap mb-20">
                        ...
                        <div class="w-full md:w-1/2 px-4">
                            ...
                            <p class="text-gray-600 text-xl">
                                You cannot only add timestamps but also
                                View/Edit/Delete them with comments/notes/tags.
                            </p>
                        </div>
                    </div>
                    <div class="flex items-center flex-wrap mb-20">
                        <div class="w-full md:w-1/2 px-4">
                            ...
                            <p class="text-gray-600 text-xl">
                                You can download audio and share audio with
                                timestamps and integrated notes/comments.
                            </p>
                        </div>
                        <div class="w-full md:w-1/2 px-4">
                            <img
                ...
                <section class="bg-white">
                    <div class="container mx-auto px-6 text-center py-10">
                        ...
                        <button
                            ...
                            class="transform hover:scale-110 transition duration-300 ease-in-out bg-primary-200 text-white font-bold rounded-full mt-6 py-6 px-8 shadow-lg uppercase tracking-wider"
                        >
                            Get Started
                        </button>
                    </div>
