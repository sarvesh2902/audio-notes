...
const ProjectList = () => {
  return (
    <div>
      <div className="overflow-x-auto relative shadow-md sm:rounded-lg mx-2 my-3">
        <table className="w-full text-sm text-left text-black dark:text-gray-400">
          <thead className="text-xs text-black dark:border-gray-400 uppercase bg-gray-500 dark:bg-gray-200 dark:text-black">
            <tr>
